...
public class KledgeCaRAdapter extends RecyclerView.Adapter<ViewHolder> {
    private List<knowledgeCategories> list;
    ...
    private final String TAG = KledgeCaRAdapter.class.getSimpleName();
    ...
    public KledgeCaRAdapter(Context context, List<knowledgeCategories> datas, boolean isOpenLoadMore, boolean ismOpenHead) {
        mContext = context;
        list = datas == null ? new ArrayList<knowledgeCategories>() : datas;
        Log.i(TAG, "list length : " + list.size());
        mOpenLoadMore = isOpenLoadMore;
        mOpenHead = ismOpenHead;
    }
    public void resetRecordDatas(List<knowledgeCategories> datas) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (holder instanceof ItemViewHolder) {
            ...
            knowledgeCategories adList = list.get(position-getheadViewCount());
            ...
            viewHolder.adTv.setText(adList.getKnowledgeCategory());
...
//        JLog.i(TAG,"list.size():"+list.size()+" getFooterViewCount()"+ getFooterViewCount()+" getheadViewCount()"+getheadViewCount());
     ...
     * @return
     */
    public knowledgeCategories getItem(int position) {
        if (list.isEmpty()) {
            return null;
        }
     ...
     * @param datas
     */
    public void setLoadMoreData(List<knowledgeCategories> datas) {
        int size = datas.size();
        list.addAll(datas);
     ...
     * @param datas
     */
    public void setData(List<knowledgeCategories> datas) {
        list.addAll(0, datas);
        notifyDataSetChanged();
    }
     ...
     * @param datas
     */
    public void setNewData(List<knowledgeCategories> datas) {
        if (isReset) {
            isReset = false;
        }
        list.clear();
