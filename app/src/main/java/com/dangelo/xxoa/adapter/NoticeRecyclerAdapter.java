...
public class NoticeRecyclerAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    private final String TAG = NoticeRecyclerAdapter.class.getSimpleName();
    ...
    public NoticeRecyclerAdapter(Context context, List<noticeInfo> datas, boolean isOpenLoadMore, boolean ismOpenHead) {
        mContext = context;
        list = datas == null ? new ArrayList<noticeInfo>() : datas;
        Log.i(TAG, "list length : " + list.size());
        mOpenLoadMore = isOpenLoadMore;
        mOpenHead = ismOpenHead;
    }
    public void resetRecordDatas(List<noticeInfo> datas) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (holder instanceof ItemViewHolder) {
            ...
            noticeInfo adList = list.get(position-getheadViewCount());
...
//            Log.i(TAG, "活动条目内容 : {" + adList.toString() + "}");
            ...
            viewHolder.adTv.setText(adList.getNotice());
...
//        JLog.i(TAG,"list.size():"+list.size()+" getFooterViewCount()"+ getFooterViewCount()+" getheadViewCount()"+getheadViewCount());
     ...
     * @param datas
     */
    public void setLoadMoreData(List<noticeInfo> datas) {
        int size = datas.size();
        list.addAll(datas);
     ...
     * @param datas
     */
    public void setNewData(List<noticeInfo> datas) {
        if (isReset) {
            isReset = false;
        }
        list.clear();
