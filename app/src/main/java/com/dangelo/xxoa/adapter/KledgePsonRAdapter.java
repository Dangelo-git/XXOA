...
public class KledgePsonRAdapter extends RecyclerView.Adapter<ViewHolder> {
    private List<knowledgePersonal> list;
    ...
    private final String TAG = KledgePsonRAdapter.class.getSimpleName();
    ...
    public KledgePsonRAdapter(Context context, List<knowledgePersonal> datas, boolean isOpenLoadMore, boolean ismOpenHead) {
        mContext = context;
        list = datas == null ? new ArrayList<knowledgePersonal>() : datas;
        Log.i(TAG, "list length : " + list.size());
        mOpenLoadMore = isOpenLoadMore;
        mOpenHead = ismOpenHead;
    }
    public void resetRecordDatas(List<knowledgePersonal> datas) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (holder instanceof ItemViewHolder) {
            ...
            knowledgePersonal adList = list.get(position-getheadViewCount());
            ...
            viewHolder.adTv.setText(adList.getUpFileCategoryName());
...
//        JLog.i(TAG,"list.size():"+list.size()+" getFooterViewCount()"+ getFooterViewCount()+" getheadViewCount()"+getheadViewCount());
     ...
     * @return
     */
    public knowledgePersonal getItem(int position) {
        if (list.isEmpty()) {
            return null;
        }
     ...
     * @param datas
     */
    public void setLoadMoreData(List<knowledgePersonal> datas) {
        int size = datas.size();
        list.addAll(datas);
     ...
     * @param datas
     */
    public void setData(List<knowledgePersonal> datas) {
        list.addAll(0, datas);
        notifyDataSetChanged();
    }
     ...
     * @param datas
     */
    public void setNewData(List<knowledgePersonal> datas) {
        if (isReset) {
            isReset = false;
        }
        list.clear();
