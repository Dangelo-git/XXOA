...
public class ExMeetRecyclerAdapter extends RecyclerView.Adapter<ViewHolder> {
    private List<ExMeet> list;
    ...
    private final String TAG = ExMeetRecyclerAdapter.class.getSimpleName();
    ...
    public ExMeetRecyclerAdapter(Context context, List<ExMeet> datas, boolean isOpenLoadMore, boolean ismOpenHead) {
        mContext = context;
        list = datas == null ? new ArrayList<ExMeet>() : datas;
        Log.i(TAG, "list length : " + list.size());
        mOpenLoadMore = isOpenLoadMore;
        mOpenHead = ismOpenHead;
    }
    public void resetRecordDatas(List<ExMeet> datas) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (holder instanceof ItemViewHolder) {
            ...
            ExMeet adList = list.get(position-getheadViewCount());
            ...
            viewHolder.adTv.setText(adList.getMeetingName());
...
//        JLog.i(TAG,"list.size():"+list.size()+" getFooterViewCount()"+ getFooterViewCount()+" getheadViewCount()"+getheadViewCount());
     ...
     * @return
     */
    public ExMeet getItem(int position) {
        if (list.isEmpty()) {
            return null;
        }
     ...
     * @param datas
     */
    public void setLoadMoreData(List<ExMeet> datas) {
        int size = datas.size();
        list.addAll(datas);
     ...
     * @param datas
     */
    public void setData(List<ExMeet> datas) {
        list.addAll(0, datas);
        notifyDataSetChanged();
    }
     ...
     * @param datas
     */
    public void setNewData(List<ExMeet> datas) {
        if (isReset) {
            isReset = false;
        }
        list.clear();
