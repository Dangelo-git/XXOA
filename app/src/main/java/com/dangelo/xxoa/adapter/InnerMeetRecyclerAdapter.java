...
public class InnerMeetRecyclerAdapter extends RecyclerView.Adapter<ViewHolder> {
    private List<InnerMeet> list;
    ...
    private final String TAG = InnerMeetRecyclerAdapter.class.getSimpleName();
    ...
    public InnerMeetRecyclerAdapter(Context context, List<InnerMeet> datas, boolean isOpenLoadMore, boolean ismOpenHead) {
        mContext = context;
        list = datas == null ? new ArrayList<InnerMeet>() : datas;
        Log.i(TAG, "list length : " + list.size());
        mOpenLoadMore = isOpenLoadMore;
        mOpenHead = ismOpenHead;
    }
    public void resetRecordDatas(List<InnerMeet> datas) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (holder instanceof ItemViewHolder) {
            ...
            InnerMeet adList = list.get(position-getheadViewCount());
            ...
            viewHolder.adTv.setText(adList.getConferenceName());
...
//        JLog.i(TAG,"list.size():"+list.size()+" getFooterViewCount()"+ getFooterViewCount()+" getheadViewCount()"+getheadViewCount());
     ...
     * @return
     */
    public InnerMeet getItem(int position) {
        if (list.isEmpty()) {
            return null;
        }
     ...
     * @param datas
     */
    public void setLoadMoreData(List<InnerMeet> datas) {
        int size = datas.size();
        list.addAll(datas);
     ...
     * @param datas
     */
    public void setData(List<InnerMeet> datas) {
        list.addAll(0, datas);
        notifyDataSetChanged();
    }
     ...
     * @param datas
     */
    public void setNewData(List<InnerMeet> datas) {
        if (isReset) {
            isReset = false;
        }
        list.clear();
