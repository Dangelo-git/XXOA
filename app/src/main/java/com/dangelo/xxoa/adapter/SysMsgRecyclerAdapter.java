...
public class SysMsgRecyclerAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    private final String TAG = SysMsgRecyclerAdapter.class.getSimpleName();
    ...
    public SysMsgRecyclerAdapter(Context context, List<SysMsg> datas, boolean isOpenLoadMore, boolean ismOpenHead) {
        mContext = context;
        list = datas == null ? new ArrayList<SysMsg>() : datas;
        Log.i(TAG, "list length : " + list.size());
        mOpenLoadMore = isOpenLoadMore;
        mOpenHead = ismOpenHead;
    }
    public void resetRecordDatas(List<SysMsg> datas) {
        this.list = (ArrayList) datas;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case TYPE_COMMON_VIEW:
                viewHolder = new ItemViewHolder(LayoutInflater.from(mContext).inflate(R.layout.sysmsg_list_item, parent, false));
                break;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (holder instanceof ItemViewHolder) {
            ...
            SysMsg adList = list.get(position-getheadViewCount());
            ...
            viewHolder.adTv.setText(adList.getContent());
...
//        JLog.i(TAG,"list.size():"+list.size()+" getFooterViewCount()"+ getFooterViewCount()+" getheadViewCount()"+getheadViewCount());
     ...
     * @return
     */
    public SysMsg getItem(int position) {
        if (list.isEmpty()) {
            return null;
        }
     ...
     * @param datas
     */
    public void setLoadMoreData(List<SysMsg> datas) {
        int size = datas.size();
        list.addAll(datas);
     ...
     * @param datas
     */
    public void setData(List<SysMsg> datas) {
        list.addAll(0, datas);
        notifyDataSetChanged();
    }
     ...
     * @param datas
     */
    public void setNewData(List<SysMsg> datas) {
        if (isReset) {
            isReset = false;
        }
        list.clear();
    ...
    public  class ItemViewHolder extends ViewHolder {
        ...
        private void initView(View itemView) {
            adRootRl=(RelativeLayout)itemView.findViewById(R.id.sysmsg_item_root);
            adTv = (TextView) itemView.findViewById(R.id.sysmsg_item_title_tx);
            adTvdate = (TextView) itemView.findViewById(R.id.sysmsg_item_title_date);
            adIv = (ImageView) itemView.findViewById(R.id.sysmsg_item_image_iv);
