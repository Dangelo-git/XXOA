...
public class Fivetab3Fragment extends BaseFragment implements FivetabContact.View {

    private FivetabPresenter fivetabPresenter;
    private String TAG = Fivetab3Fragment.class.getSimpleName();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        fivetabPresenter.setType(TYPE_JU);
    ...
    public void refreshData(List<knowledgeCategories> data) {
        ...
        for (int i = 0; i < data.size(); i++) {
            JLog.i(TAG, "data.get(i).getAd_id():" + data.get(i).getKnowledgeCategory());
...
//        JLog.i(TAG,"ShortCut.isShowAdList"+ShortCut.isShowAdList);
        mAdAdapter = new KledgeCaRAdapter(getActivity(), data, false,false);
