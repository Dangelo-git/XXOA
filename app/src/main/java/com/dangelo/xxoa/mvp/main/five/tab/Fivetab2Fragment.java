...
public class Fivetab2Fragment extends BaseFragment implements FivetabContact.View {

    private FivetabPresenter fivetabPresenter;
    private String TAG = Fivetab2Fragment.class.getSimpleName();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        fivetabPresenter.setType(TYPE_KE);
