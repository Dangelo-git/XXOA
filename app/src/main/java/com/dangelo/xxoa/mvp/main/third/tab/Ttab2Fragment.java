...
public class Ttab2Fragment extends BaseFragment implements TtabContact.View {

    private TtabPresenter ttabPresenter;
    private String TAG = Ttab2Fragment.class.getSimpleName();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        ttabPresenter.setType(TYPE_UNFINISH);
        page=1;
