...
public class Ttab5Fragment extends BaseFragment implements TtabContact.View {

    private TtabPresenter ttabPresenter;
    private String TAG = Ttab5Fragment.class.getSimpleName();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        ttabPresenter.setType(TYPE_STOP);
        page=1;
