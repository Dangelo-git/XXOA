...
public class Stab4Fragment extends BaseFragment implements StabContact.View {

    private StabPresenter stabPresenter;
    private String TAG = Stab4Fragment.class.getSimpleName();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        stabPresenter.setType(TYPE_DRAFT);
        page=1;
