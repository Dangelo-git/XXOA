...
public class Ttab3Fragment extends BaseFragment implements TtabContact.View {

    private TtabPresenter ttabPresenter;
    private String TAG = Ttab3Fragment.class.getSimpleName();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        ttabPresenter.setType(TYPE_FINISH);
        page=1;
