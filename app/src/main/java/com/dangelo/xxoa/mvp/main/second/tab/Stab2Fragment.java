...
public class Stab2Fragment extends BaseFragment implements StabContact.View {

    private StabPresenter stabPresenter;
    private String TAG = Stab2Fragment.class.getSimpleName();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        stabPresenter.setType(TYPE_UNFINISH);
