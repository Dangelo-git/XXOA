...
public class Ttab1Fragment extends BaseFragment implements TtabContact.View {

    private TtabPresenter ttabPresenter;
    private String TAG = Ttab1Fragment.class.getSimpleName();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        ttabPresenter.setType(TYPE_WAIT);
        ttabPresenter.GetDate(1);
        page=1;
    }
...
//        JLog.i(TAG,"ShortCut.isShowAdList"+ShortCut.isShowAdList);
        mAdAdapter = new InDocRecyclerAdapter(getActivity(), data, true,false);
