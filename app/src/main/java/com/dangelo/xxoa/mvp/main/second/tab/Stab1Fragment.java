...
public class Stab1Fragment extends BaseFragment implements StabContact.View {

    private StabPresenter stabPresenter;
    private String TAG = Stab1Fragment.class.getSimpleName();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        stabPresenter.setType(TYPE_WAIT);
        stabPresenter.GetDate(1);
        page=1;
    }
...
//        JLog.i(TAG,"ShortCut.isShowAdList"+ShortCut.isShowAdList);
        mAdAdapter = new DispDocRecyclerAdapter(getActivity(), data, true,false);
