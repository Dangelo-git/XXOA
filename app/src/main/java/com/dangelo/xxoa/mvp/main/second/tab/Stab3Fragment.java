...
public class Stab3Fragment extends BaseFragment implements StabContact.View {

    private StabPresenter stabPresenter;
    private String TAG = Stab3Fragment.class.getSimpleName();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        stabPresenter.setType(TYPE_FINISH);
        page=1;
